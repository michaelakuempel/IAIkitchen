...
- check the following Capabilities: 
    ...
    SpatialPerception (if you want to include object recognition and/ or anchors)
in -> XR Settings
- check: Virtual Reality Supported (ensure Windows Mixed Reality is set)
	 Vuforia Augmented Reality Supported (again for object recognition)
Quality settings:
- set the quality for your used system to low


Project setup for Mixed Reality:
...
For VR keep the Skybox setting
...
To load the project, go to the created folder and click on LabScan.sln to open the project in Visual Studio.
